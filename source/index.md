...
9. [The Browser DOM](text/9-dom-intro/index.md)
    1. [HTML and CSS Review](text/9-dom-intro/html_css.md)
    2. [The DOM as a Type Hierarchy](text/9-dom-intro/dom_tree.md)
    3. [Accessing and Modifying DOM Elements](text/9-dom-intro/querying.md)
    4. [Events and EventTarget](text/9-dom-intro/events_intro.md)
10. [Advanced Browser APIs](text/10-dom-advanced/index.md)
    1. [Custom HTML Elements](text/10-dom-advanced/custom_elements.md)
    2. [Dynamic DOM Manipulation](text/10-dom-advanced/dom_manipulation.md)
    3. [Custom Events and Component Communication](text/10-dom-advanced/custom_events.md)
    4. [Drawing with the Canvas API](text/10-dom-advanced/canvas.md)
    5. [Sound and the Web Audio API](text/10-dom-advanced/audio_api.md)
...
12. [Higher Order Methods](text/12-high-order-methods/index.md)
    ...
    2. [Implementation of HO Methods](text/12-high-order-methods/implementation.md)
