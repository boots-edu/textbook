...
and we want to find the number 100 in the tree.  We woudl start by comapring it to 44.  Since 100 > 44 we know the answer must be in the right subtree if this is a ***binary search tree***.
...
Our function should have ***stop conditions*** when the tree is empty or when the value in the root of the tree is the one we are looking for.
...
***Trees*** are a common data structure in Computer Science and recursion is a much more natural way to deal with them.
