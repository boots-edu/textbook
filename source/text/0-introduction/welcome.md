...
9. Chapter 9 will introduce browser-native APIs and how to create web applications without a framework: This will let us create interactive applications that run in a web browser while reinforcing OOP.
10. Chapter 10 will introduce advanced browser API patterns and project designs: This will let us create richer interfaces with events, timers, canvas, and audio.
...
-   If you are looking for an introductory programming textbook, we can recommend [The Python Bakery](https://blockpy.cis.udel.edu/assignments/textbook/bakery_textbook) (by some of the same authors), although that will be in Python instead of TypeScript. This is a suitable text for a CS1 Python course, and it is free and open-source.

-   If you are looking for a more advanced textbook on developing web applications in TypeScript using React, we can recommend [The TypeScript Tome](https://frontend-fun.github.io/react-hooks-typescript-tome/) (by some of the same authors). This is a suitable text for an introductory Software Engineering course, and it is also free and open-source.
...
First review our [HTML and CSS primer &raquo;](../0-introduction/html-css-primer.md), then continue to [environment setup &raquo;](../0-introduction/setup.md)
